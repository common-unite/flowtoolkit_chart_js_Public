...
- **Flow Tool Kit: Chart.js** installed in your org. The quickest route is [install.common-unite.com/products/form-chart](https://install.common-unite.com/products/form-chart), which installs the base package and Chart.js together. Otherwise see the [latest release](https://github.com/common-unite/flowtoolkit_chart_js_Public/releases/latest) for the most current install URL and changelog. Direct install links for the current production release (**0.7.0.1**):
  - Sandbox / Scratch: [test.salesforce.com install link](https://test.salesforce.com/packaging/installPackage.apexp?p0=04tRQ000000Aw9BYAS)
  - Production / DE: [login.salesforce.com install link](https://login.salesforce.com/packaging/installPackage.apexp?p0=04tRQ000000Aw9BYAS)
...
Picking **Timeline (Gantt)** swaps the aggregate fields for timeline mapping (start/end dates, milestones, color-by) - see the [Timeline guide](TIMELINE_GANTT.md).
...
- Build a Gantt-style schedule - grant deliverables, program phases, project timelines - see the [Timeline (Gantt) guide](TIMELINE_GANTT.md).
