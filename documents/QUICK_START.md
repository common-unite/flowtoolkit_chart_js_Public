...
- **Flow Tool Kit: Chart.js** installed in your org — see the [latest release](https://github.com/common-unite/flowtoolkit_chart_js_Public/releases/latest) for the most current install URL and changelog. Direct install links for the current production release (**0.2.0.2**):
  - Sandbox / Scratch: [test.salesforce.com install link](https://test.salesforce.com/packaging/installPackage.apexp?p0=04tRQ0000009IH3YAM)
  - Production / DE: [login.salesforce.com install link](https://login.salesforce.com/packaging/installPackage.apexp?p0=04tRQ0000009IH3YAM)
